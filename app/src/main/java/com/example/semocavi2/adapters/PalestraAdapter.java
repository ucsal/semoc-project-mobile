...
// ajeitar o back antes de fazer a recycele view
public class PalestraAdapter  {
// extends RecyclerView.Adapter<MiniCursoAdapter.MiniCursoViewHolder>
...
//    @NonNull
//    @Override
//    public PalestraAdapter. onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
